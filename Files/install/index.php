									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-sm-6">
												<input type="text" name="user" placeholder="Enter Anything" value="Mahmoud" required>
											</div>
											<div class="information-form-group col-sm-6">
												<input type="text" name="code" placeholder="Enter Anything" value="DoniaWeB.com" required>
											</div>
										</div>
									</div>
									<div class="info-item">
